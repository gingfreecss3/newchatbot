...
AS $$
DECLARE
  project_url TEXT := 'https://sfxzxlgiztydvhputzar.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNmeHp4bGdpenR5ZHZocHV0emFyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNDg5ODE2MCwiZXhwIjoyMDIwNDc0MTYwfQ.MKDj5xZSUby3thDPqoLcIo69ldBwFaRvQZ1VkoKVIYQ'; -- full access needed for http request to storage
